...
export default function ApexChart(props) {
  ...
  },
  {
   ...
   var optionsValues = {
    options: {
      ...
      title: {
        text: 'Advance Declines Analysis',
        align: 'center'
      },
      grid: {
        row: {
  ...
  useEffect(() => {
    ...
    var advances=props.advances;
    var declines=props.declines;

    

    seriesValues.series[0].data=advances;
    seriesValues.series[1].data=declines;
