    ...
    <div className={classes.root}>
      ...
      >
        <div className={classes.drawerHeader} id={styles.drawerHeader}>
          <IconButton onClick={handleDrawerClose} id={styles.backIcon}>
            {theme.direction === 'ltr' ? <ChevronLeftIcon /> : <ChevronRightIcon  />}
          </IconButton>
        </div>
        <Divider />
        <Router>
        <List  id={styles.drawer}>
          {<>
            <Link to={'/'}>
            ...
            <Link to={'/optionChain'}>
            <ListItem button key={'Option Chain Analysis'} >
        ...
        <Route exact path="/" component={OptionChain}> </Route>
        </Router>
      </Drawer>
      <main
